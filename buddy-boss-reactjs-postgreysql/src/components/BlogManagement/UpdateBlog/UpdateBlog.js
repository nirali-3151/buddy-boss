...
class UpdateBlog1 extends Component {
  ...
  changeValueOfSingleQuateDescription = () => {
    ...
    const replaced = description.replaceAll("'", "''");
  ...
  onClickPublishBtn = async () => {
    ...
    if (thumb_nail_image === "" || title === "" || description === "" || catagory_name === "" || radio_btn_select === "") {
      ...
      if (!thumb_nail_image) {
        ...
        formData.append('thumb_nail_img', data)
        formData.append('title', title_replaced)
        formData.append('description', description_replaced)
