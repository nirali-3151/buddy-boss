...
class RegisterPage1 extends Component {
    ...
    onClickRegisterBtn = async (e) => {
        ...
        if (errors.userName === "" && errors.email === "" && errors.password === "" && errors.confirm_password === "" && Data.userName !== "" && Data.email !== "" && Data.password !== "" && Data.confirm_password !== "") {
            ...
            const initialData = await UserService.RegisterUserList(newData);
    ...
    //         console.log("prevState.Data.length" ,this.state.Data.password);
    //         console.log("this.state.errors.length",this.state.Data.confirm_password);
    //         const isDiff = this.state.Data.password.length === this.state.Data.confirm_password.length &&  this.state.Data.password.length !== 0 
    //         if(isDiff)
    //         {
