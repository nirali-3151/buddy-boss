...
class ViewBlogCatagory1 extends Component {
    ...
    getViewCatagoryData = async () => {
        ...
        const initialData = await httpClient.blogCatagoryViewBlog(Token);
        this.props.getBlogCatagoryData1({ blog_catagory_Data: initialData.ViewBlogCatagoryData })
    }
    ...
    onClickDeleteCatagoryBtn = async (user) => {
        ...
        const initialData = await httpClient.blogCatagoryDeleteBlog(newData);
