...
class Body1 extends Component {
    ...
    getUsersEveryBlog = async () => {
        ...
        const initialData = await httpClient.userFeaturedBlogWithId(newData)
        this.props.getAllUserBLog1({ get_blog_user_id: initialData.userFeaturedBlog })
    }
    ...
    getUserMainBlog = async () => {
        ...
        const initialData = await httpClient.userMainBlogWithId(newData)
        this.props.getMainUserBlogDataPerticularId1({ Main_blog_data: initialData.userMainBlog })
    }
