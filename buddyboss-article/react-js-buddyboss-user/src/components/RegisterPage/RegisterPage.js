    ...
    handleValidate = (e) => {
        ...
        switch (name) {
            ...
            case 'confirm_password':
                console.log("value.password ", this.state.Data.password);
                console.log("confirm_password", this.state.Data.confirm_password);
                errors.confirm_password =
                    Data.password !== Data.confirm_password && value.length !== 0
                        // value.length < 8 && value.length !== 0
