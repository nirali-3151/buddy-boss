...
import UserHomePageLeftSide from './UserHomePageLeftSide'
...
class UserHomePage1 extends Component {
    constructor(props) {
        super(props);
    }
...
const mapStateToProps = state => {
  ...
  const Add = connect(mapStateToProps, mapDispatchToProps)(UserHomePage1);
